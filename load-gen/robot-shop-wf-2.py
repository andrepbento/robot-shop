import random
from listeners_wf import init_csv_file, request_event_listener
...
class UserBehavior(FastHttpUser):
    ...
    @task
    def load_2(self):
        self.client.get('/api/user/uniqueid', headers={'x-forwarded-for': self.fake_ip})

    @task
    def load_3(self):
        self.client.get('/api/catalogue/products', headers={'x-forwarded-for': self.fake_ip})
