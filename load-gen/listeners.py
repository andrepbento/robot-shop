...
header='timestamp,service,replicas,load,name,request_type,response_time,status_code'
...
def request_event_listener(context, **kwargs):
    ...
    line = f"{start_time},{service},{replicas},{load},{name},{request_type},{response_time},{status_code}\n"
    f.write(line)
    f.close()
